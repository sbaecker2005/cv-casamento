...
export function ImageHero({
  ...
  className="absolute inset-0 w-full h-full object-contain object-center pointer-events-none select-none"
        ...
        decoding="async"
      />
      <div aria-label={`Imagem destaque ${(imageIndex + 1)}`} className="absolute inset-0 w-full h-full bg-brand-sage-700/30" />
  <div className="absolute inset-0 bg-gradient-to-br from-brand-sage-700/60 via-brand-sage-700/45 to-brand-coffee-700/35" />
